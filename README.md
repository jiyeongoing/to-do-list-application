...
- 로그인 없이 무료 GitHub Pages에서 실행 가능한 로컬 저장형 구성
...
- Constraint: Free hosting, device-local storage
...
현재 공개 버전은 브라우저 기기의 `localStorage`에 저장합니다.
다른 기기로 옮길 때는 백업 파일을 내려받아 복원할 수 있습니다.
