...
- Demo: https://jiyeongoing.github.io/to-do-list-application/?v=15
...
공개 데모: https://jiyeongoing.github.io/to-do-list-application/?v=15
...
이메일/비밀번호 회원가입과 로그인을 지원합니다. 비밀번호는 원문이 아니라 BCrypt
해시로 저장하고, 로그인 상태는 서버 세션으로 유지합니다. 백엔드에 Google OAuth
