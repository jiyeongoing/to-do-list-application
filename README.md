...
- Demo: https://jiyeongoing.github.io/to-do-list-application/?v=20
...
- Node 기본 테스트 러너로 주요 동작 26개 케이스 검증
...
공개 데모: https://jiyeongoing.github.io/to-do-list-application/?v=20
...
- 게스트 저장 유지, 이메일/비밀번호 계정 저장, 이 기기 데이터 가져오기
...
비밀번호는 원문이 아니라 BCrypt 해시로 저장하고, 로그인 상태는 서버 세션으로 유지합니다.
서버가 꺼져 있어도 기존 로컬 저장 흐름은 유지됩니다.
